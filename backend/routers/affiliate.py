...
@affiliate_router.post("/create/affiliate", tags=["CRUD AFILADOS"], dependencies=[Depends(JWTBearer())])
...
@affiliate_router.get("/filter/affiliate", tags=["CRUD AFILADOS"])
...
@affiliate_router.put("/update/affiliate", tags=["CRUD AFILADOS"])
...
@affiliate_router.delete("/update/affiliate", tags=["CRUD AFILADOS"])
