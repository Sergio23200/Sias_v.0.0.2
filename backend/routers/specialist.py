...
@specialist_router.get("/all/specialist", tags=["CRUD SPECIALIST"])
...
@specialist_router.put("/update/specialist", tags=["CRUD SPECIALIST"])
...
@specialist_router.delete("/dalete/specialist", tags=["CRUD SPECIALIST"])
