...
@hospital_router.get("/all/hospital", tags=["CRUD HOSPITAL"])
...
@hospital_router.put("/update/hospital", tags=["CRUD HOSPITAL"])
...
@hospital_router.delete("/dalete/hospital", tags=["CRUD HOSPITAL"])
