...
@ips_router.post("/create/ips", tags=["CRUD IPS"])
...
@ips_router.get("/all/ips", tags=["CRUD IPS"])
...
@ips_router.put("/update/ips", tags=["CRUD IPS"])
...
@ips_router.delete("/dalete/ips", tags=["CRUD IPS"])
